...
- https://github.com/Vick606/subcanopy-guard [Context-Aware Indirect Prompt Injection Scanner]
...
- https://github.com/mnemoverse/mcp-memory-server [Mnemoverse - hosted persistent memory for AI agents over MCP; tell it a recalled memory helped or misled and it re-ranks recall; remote endpoint with OAuth or local npx with a key; MIT server, hosted engine, free tier]
...
- https://github.com/CursorTouch/Windows-MCP [Windows-MCP - MCP server for computer use on Windows: UI automation, app/window control, keyboard/mouse, screenshots/snapshots; stdio/SSE/HTTP; PyPI uvx; MIT]
...
- https://github.com/atomicstrata/llm-wiki-compiler [llm-wiki-compiler - knowledge compiler: raw sources in, interlinked wiki out; Karpathy LLM Wiki pattern]
